                    ...
                    ->children()
                        ->arrayNode('store_review')
                            ...
                            ->children()
                                ->booleanNode('enabled')
                                    ->defaultTrue()
                                    ->info('Whether to auto-approve store reviews')
                                ->end()
                                ->integerNode('minimum_rating')
                                    ->defaultValue(4)
                                    ->info('The minimum rating for auto-approving store reviews')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('product_review')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->booleanNode('enabled')
                                    ->defaultTrue()
                                    ->info('Whether to auto-approve product reviews')
                                ->end()
                                ->integerNode('minimum_rating')
                                    ->defaultValue(4)
                                    ->info('The minimum rating for auto-approving product reviews')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
